...
public class Person {
	...
	public boolean equals(Object t) { //åtkomstmetod: public, returtyp: boolean(true/false), metodnamn: equals, variabeltyp: Object, variabelnamn: t.
			Person p = (Person) t; //Här castar vi det inmatade Objektet till en Person
			return this.fnamn.equals(p.fnamn) && this.enamn.equals(p.enamn);
		}
	...
	public boolean equals1(Object t) {
		if (t instanceof Person) { // instanceof är en inbyggd metod som ser ifall Object är en instans av den specificerade typen, i detta fall klassen Person
			Person p = (Person) t;
	...
	public boolean equals2(Object t) {
		return t instanceof Person && ((Person) t).getFnamn().equals(this.fnamn)
				&& ((Person) t).getEnamn().equals(this.enamn);
	}
